...
/**
 * Servlet implementation class ReportNoteDetail
 */
@WebServlet("/report/note/detail")
public class ReportNoteDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportNoteDetail() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Report report = new ReportService().reportNoteDetail(rid);
