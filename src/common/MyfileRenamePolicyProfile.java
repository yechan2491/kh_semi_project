...
public class MyfileRenamePolicyProfile implements FileRenamePolicy{

	@Override
	public File rename(File originFile) {
		/* 전달 받은 원본 파일명을 중복 되는 값 없게끔 변경 된 파일명을 반환하는 기능 */
		...
		/* 최종 수정할 파일명 (년월일시분초 + 최대 5자리 랜덤 값 + 파일 확장자) */
		String rename = "profile" + sdf.format(new Date()) + (int)(Math.random() * 100000) + ext;
