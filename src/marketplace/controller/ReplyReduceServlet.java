...
/**
 * Servlet implementation class ReplyReduceServlet
 */
@WebServlet("/marketplace/reduceReply")
public class ReplyReduceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReplyReduceServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Reply> replyList =new MarketplaceService().reduceReply(reply);
