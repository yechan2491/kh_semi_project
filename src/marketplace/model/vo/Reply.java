...
//	AID2	NUMBER
	...
	private String timeMessage; // 1분전 1년전 등등 표시를위함
	
	private String timeView;
	public Reply() {
	}
	public Reply(int aid, String acontent, Date createDate, Date modifyDate, int bid, String userName, String nickName,
			int writer, String status, int aid2, String profilePath, String timeMessage, String timeView) {
		this.aid = aid;
	...
	public String toString() {
		return "Reply [aid=" + aid + ", acontent=" + acontent + ", createDate=" + createDate + ", modifyDate="
				...
				+ writer + ", status=" + status + ", aid2=" + aid2 + ", profilePath=" + profilePath + ", timeMessage="
				+ timeMessage + ", timeView=" + timeView + "]";
	}
