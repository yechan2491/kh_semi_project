...
.show .popup {
  ...
  <body>
	...
	<%
		...
		sendNickname=URLDecoder.decode(sendNickname,"UTF-8");
		ncontent=URLDecoder.decode(ncontent,"UTF-8");
		ntitle=URLDecoder.decode(ntitle,"UTF-8");
	%>
   
   <div class="background">
      <div class="window">
                <form method="post" action="${contextPath }/report/note/insert">
                <input type="hidden" name="nno" value="${ param.nno }">
                <input type="hidden" name="writer" value="${ param.sendId }">
                <input type="hidden" name="rwriter" value="${ param.receiveId }">
        <div class="popup">
