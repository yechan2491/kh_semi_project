	...
	<div class="outer">
		<div class="wrap">
			<div class="infocontainer">
				<form action="${ contextPath }/info/insert" method="POST" enctype="multipart/form-data">
				<div class="content">
					<span class="title_span">&nbsp;</span> 분류
					<span class="input_area"> 					
					<select name="category" required>
							<option value="1">청소</option>
							<option value="2">꾸미기</option>
							<option value="3">리폼</option>
							<option value="4">생활정보</option>
					</select>
					</span>
					<div class="formgroup">
						<br> <br> <label for="title">제목 : </label> <input
							type="text" class="formcontrol" placeholder="title"
					...
					<div class="btninsertarea">
						<button type="submit" class="btn">글쓰기 등록</button>
						<br> <br>
					</div>
				</form>
			</div>
